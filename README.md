...
- `ITSflye/`  
  De novo consensus assemblies per barcode generated with `Flye`.

- `wfampliconref_new/`  
  Consensus sequences generated by `wf-amplicon` using reference-based variant calling.

- `wfamplicon_de_novo/`  
  De novo consensus sequences generated by `wf-amplicon` without a reference.
